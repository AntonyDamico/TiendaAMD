...
function Header()
{
	...
	$this->Ln(15);
	$this->Cell(60);
	$this->Cell(70,10,'Listado de Ubicaciones',0,0,'C');
	//Salto de línea
	$this->Ln(20);
	// enca
	$this->Cell(15);
...
include('../config/conexi.php');
			  	...
			  	// para el paginador
				$wsqli="select estatus.nombre as idestatus, ubicacion.nombre as nombre, ubicacion.idubicacion
				from ubicacion
