	...
	?>
		...
		<div class="col-md-6 col-md-offset-3"> <!--ingreso de datos-->
			<form method="post" action="back/ubicacion/<?php echo $destino ?>" class="form-horizontal">
				...
				<div class="panel panel-primary text-center">
					...
					<div class="panel-footer">
						...
						<?php
							if(isset($_GET['id'])){
								echo '<a href="sistema.php?pag=ubicacion" class="btn btn-default">Regresar</a>';
							} else {
		...
		<div class="col-md-10 col-md-offset-1"> <!--Ver datos-->
			...
			<table class="table table-bordered table-striped table-hover"  id="datatableplugin">
				...
				<tbody>
				<?php
					$wsqli="select idubicacion, estatus.nombre as estatus, ubicacion.nombre as nombre from ubicacion
					inner join estatus on ubicacion.idestatus = estatus.idestatus
					order by ubicacion.nombre "; //la variable se llama cursor (WorkingSQLI)
					$result = $linki->query($wsqli);
				...
				?>
					<tr class="text-center">
						...
						<td>
							<a href="sistema.php?pag=ubicacion&id=<?php echo $id ?>" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-edit"> Modificar</span></a>
							<a class="btn btn-danger btn-xs eliminar_dato"  title="<?php echo '<center>Seguro que desea eliminar este registro:<br><p><b>'.$n.'</b></p><center>' ?>" href="back/ubicacion/eliminar.php?id=<?php echo $id ?>"><span class="glyphicon glyphicon-trash"> Eliminar</span></a> 
						</td>
					</tr>
				<?php 
					} 
			...
			<div class="col-md-offset-5">
				<a class="btn btn-primary btn-sm text-center" href="pdfphp/pdfubicacion.php">IMPRIMIR</a>
			</div>
			<br>
		<p>..</p>
